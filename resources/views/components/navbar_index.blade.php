    ...
    <header class="navbar">
       <a href="/sell" class="logo-container"><img src="{{ asset('images/logo-pamana.png') }}" alt="" class="logo-image"></a>
        ...
        <div class="buttons-container">
            <button class="btn-account btn-cart"><a href="/login"><i class="fa-solid fa-shopping-cart"></i></a></button>
            <button class="btn-account btn-signup" ><a href="/login"><i class="fa-solid fa-envelope"></i></a></button>
            <button class="btn-account btn-login"><a href="/login"><i class="fa-solid fa-bell"></i></a></button>
